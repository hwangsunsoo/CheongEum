...
# 훈맹청음 개발본 (訓盲聽音 開發本)
- 문제원인: 스크린리더를 통해 들리는 소리가 화면에 나타난 정보와 달라, 의미가 서로 통하지 아니하므로,
- 문제제시: 시력이 낮은 사람이 이루고자 하는 바가 있어도 그 뜻을 펴지 못하는 경우가 많습니다.
- 연구요약: 이를 안타깝게 여겨, 새롭게 280줄의 코드를 작성하여 웹 브라우저에서 정보를 음성으로 변환하는 기능을 만들었으니,
- 기대효과: 사용자가 정보에 자유롭게 접근하기에 편안하게 하고자 할 따름입니다.
